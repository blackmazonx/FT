...
class Bandtastic(IStrategy):
    ...
    buy_fastema = IntParameter(low=1, high=236, default=150, space='buy', optimize=True, load=True)
    buy_slowema = IntParameter(low=1, high=365, default=182, space='buy', optimize=True, load=True)
    buy_rsi = IntParameter(low=15, high=70, default=56, space='buy', optimize=True, load=True)
    buy_mfi = IntParameter(low=15, high=70, default=45, space='buy', optimize=True, load=True)
    ...
    sell_fastema = IntParameter(low=1, high=365, default=106, space='sell', optimize=True, load=True)
    sell_slowema = IntParameter(low=1, high=365, default=105, space='sell', optimize=True, load=True)
    sell_rsi = IntParameter(low=30, high=100, default=66, space='sell', optimize=True, load=True)
    sell_mfi = IntParameter(low=30, high=100, default=42, space='sell', optimize=True, load=True)

    sell_rsi_enabled = CategoricalParameter([True, False], space='sell', optimize=True, default=False)
    sell_mfi_enabled = CategoricalParameter([True, False], space='sell', optimize=True, default=False)
    sell_ema_enabled = CategoricalParameter([True, False], space='sell', optimize=True, default=True)
